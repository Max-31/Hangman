    ...
    try{
        ...
        if(action === 'DENIED'){
            ...
            if(player && player.isEmailVerified && player.email){
                ...
                const emailSubject = `OOPS! Sorry, Your Hangman Contribution has been ${action}!`;
                const emailBody = `
                    <div style="background-color: #020126; padding: 40px 20px; font-family: 'Arial', sans-serif; color: #ffffff;">
                        <div style="max-width: 600px; margin: 0 auto; background-color: #0A0140; padding: 30px; border-radius: 12px; border: 1px solid #150259; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
                            ...
                            <div style="text-align: center; margin-top: 40px; margin-bottom: 20px;">
                                <a href="https://hangman-c0h7.onrender.com" style="background-color: #4630D9; color: #ffffff; padding: 14px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; display: inline-block; box-shadow: 0 4px 15px rgba(70, 48, 217, 0.4);">
                                    Play Hangman Now
                                </a>
                            </div>
