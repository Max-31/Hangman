...
//       // const res = await axios.get(`${url}/contribution/genres`, {
//       //   withCredentials: true,
//       // });
//       const apiRequest= axios.get(`${url}/contribution/genres`, {
//         withCredentials: true,
...
//       // const res = await axios.get(`${url}/contribution/my-requests/${userID}`, {
//       //   withCredentials: true,
//       // });
//       const apiRequest = axios.get(`${url}/contribution/my-requests/${userID}`, {
//         withCredentials: true,
//       });
...
//         contributionType: type,
//         word: formData.word,
//         linkedGenre: type === "word" ? formData.linkedGenre : undefined,
//         newGenre: type === "genre" ? formData.newGenre : undefined,
//       };
...
//       setFormData({ word: "", linkedGenre: "", newGenre: "" });
//       setActiveTab("HISTORY");
//       setStatusFilter("ALL");
//     } catch (err) {
//       const msg = err.response?.data?.message || "Submission Failed";
...
//                 <label
//                   className={`toggle-label ${type === "genre" ? "selected" : ""}`}
//                 >
//                   <div className="radio-circle">
//                     {type === "genre" && <div className="inner-circle" />}
//                   </div>
...
//                       value={formData.linkedGenre}
//                       onChange={(e) =>
//                         setFormData({
//                           ...formData,
//                           linkedGenre: e.target.value,
//                         })
//                       }
//                       required
//                     >
...
//                         setFormData({
//                           ...formData,
//                           newGenre: e.target.value.toUpperCase(),
//                         })
//                       }
//                       required
//                     />
