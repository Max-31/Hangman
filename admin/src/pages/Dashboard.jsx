        ...
        {visibleRequests.map((req) => (
          <div key={req._id} className="bg-royal-light/10 border border-royal-light/20 rounded-2xl p-6 hover:border-gold-vibrant/50 transition-colors group relative overflow-hidden">
            ...
            <div className="mb-4">
              ...
              <h2 className="text-2xl font-bold text-white mt-3 mb-1">{req.word}</h2>
              <p className="text-sm opacity-70">
                Genre: <span className="text-gold-vibrant">{req.contributionType === 'genre' ? req.newGenre : req.linkedGenre?.name}</span>
              </p>
            </div>
